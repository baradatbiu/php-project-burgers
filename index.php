        ...
        <section class="section order">
          <div class="container">
            ...
            <div class="order__form">
              <form action="php/register.php" METHOD="get" class="order__form-tag" id="order-form">
                  ...
                  <div class="order__form-buttons">
                    <div class="order__form-row">
                      <label class="order__radio">
                        <input class="order__radio-elem" name="payment" value="change" type="radio">
                        <div class="order__radio-fake"></div>
                        <div class="order__radio-title">Потребуется сдача</div>
                      </label>
                      <label class="order__radio">
                        <input class="order__radio-elem" name="payment" value="card" type="radio">
                        <div class="order__radio-fake"></div>
                    ...
                    <div class="order__form-row">
                      <label class="order__radio order__radio_checkbox">
                        <input class="order__radio-elem" name="callback" value="no" type="checkbox">
                        <div class="order__radio-fake"></div>
